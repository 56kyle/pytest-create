...
@pytest.fixture(scope="session")
def example_package_data_dir(example_package_dir: pathlib.Path) -> pathlib.Path:
    """Returns the path to the example package data directory."""
    return example_package_dir / "data"
